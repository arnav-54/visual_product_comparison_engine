...
cd visual-product-comparison-engine
...
## Acknowledgments
- TensorFlow.js team for browser ML framework
...
*Demonstrating the power of edge AI and privacy-preserving machine learning*
